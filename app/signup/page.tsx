                ...
                >
                    <div className="p-8">
                        ...
                        <div className="text-center mb-6">
                            <div className="inline-flex items-center gap-2 mb-5 bg-white/5 px-3 py-1.5 rounded-full border border-white/5">
                    ...
                    <div className="px-10 py-6 bg-white/[0.02] border-t border-white/5 text-center">
                        <p className="text-sm text-zinc-500">
                            Already have an account? <Link href="/login" className="text-white font-bold hover:underline decoration-zinc-700 underline-offset-4 ml-1 transition-colors">Log in</Link>
                        </p>
                    </div>
                </motion.div>
